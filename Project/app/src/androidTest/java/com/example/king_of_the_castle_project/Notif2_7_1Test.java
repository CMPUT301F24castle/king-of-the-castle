...
public class Notif2_7_1Test {
    private Context context;
    private NotificationManager mockNotificationManager;
    private Notif2_7_1 notifier;
    ...
    public void setUp() {
        ...
        notifier = new Notif2_7_1(context);
    }

        @Test
        public void testnotifyWaitingListEntrants() {
            // Arrange: Set up the notification builder
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "notifyWaitingListEntrants")
